        ...
        while (true) {
            ...
            while (true) {
                ...
                if (cmd.equals("-")) {
                    ...
                    LoggingService.logError("Выбрана не верная команда попробуйте еще раз!");
                }               
            }
